...
import { scheduleHeroImage } from '../../data/scheduleData'
    ...
    <section className="relative isolate overflow-hidden">
      <div className="absolute inset-0 -z-10 bg-black">
        <img
          ...
          alt="Premium dark gym studio prepared for group training classes"
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-[#F97316]">Weekly Classes</p>
          <h1 className="text-4xl font-black tracking-tight text-white sm:text-5xl lg:text-6xl">
            Plan Your Week. Train With Purpose.
          </h1>
          <p className="mt-4 max-w-2xl text-base text-[#D4D4D4] sm:text-lg">
            Browse every strength, conditioning, and recovery class running across the week, filter by day, trainer, or difficulty, and reserve your spot in seconds.
          </p>
        </motion.div>
      </div>
    </section>
